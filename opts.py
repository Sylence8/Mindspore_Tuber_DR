...
def parse_opts():
    ...
    parser.add_argument('--fusion_dir', type=str, help='nodule_sample_min/max/mean')
    ...
    parser.add_argument('--alp', default=0.5, type=float, help='augmentation')
    ...
    parser.add_argument('--no_val',default=False,type=bool,help='If true,validation not performed.')
